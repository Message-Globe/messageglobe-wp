 ...
 * Description:       Send SMS notifications and route WordPress email through MessageGlobe for reliable delivery. Integrates with WooCommerce.
 * Version:           1.0.0
...
define('MESSAGEGLOBE_WP_VERSION', '1.0.0');
